                  ...
                  <>
                    {cart.length === 0 ? (
                      ...
                      <div className="flex-1 overflow-y-auto space-y-6 pr-2 custom-scrollbar">
                        {cart.map(item => (
                          <div key={`${item.id}-${item.selectedSize || 'no-size'}`} className="flex gap-4 bg-black/20 p-4 border border-white/5">
                            ...
                            <div className="flex-1">
                              ...
                              {item.selectedSize && (
                                <p className="text-soltan-cyan font-mono text-xs mb-2">Size: {item.selectedSize}</p>
                              )}
